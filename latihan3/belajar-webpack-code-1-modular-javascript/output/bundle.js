...
const run = (alertService, calculatorService, jokesService) => {
  ...
  calculatorService.onClick(() => {
    ...
    const angka = (0,_utils_parseInput__WEBPACK_IMPORTED_MODULE_1__.parseInput)(...input);
    if ((0,_utils_cekInputValid__WEBPACK_IMPORTED_MODULE_0__.cekInputValid)(...angka)) {
...
/* harmony import */ var _app_calculator_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./app/calculator.service */ "./src/app/calculator.service.js");
/* harmony import */ var _app_jokes_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./app/jokes.service */ "./src/app/jokes.service.js");
...
const calculatorService = new _app_calculator_service__WEBPACK_IMPORTED_MODULE_2__.CalculatorService();
const jokesService = new _app_jokes_service__WEBPACK_IMPORTED_MODULE_3__.JokesService();

(0,_app_app__WEBPACK_IMPORTED_MODULE_0__.run)(alertService, calculatorService, jokesService);
